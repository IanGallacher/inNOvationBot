 ...
 * Taken from JarCraft, which in turn took this from JNIAPI
 * https://github.com/JNIBWAPI/JNIBWAPI/blob/164005d18a6d2f0abae95c761002096a9067e8e1/src/java/jnibwapi/types/UpgradeType.java
 */
public class UpgradeType { 
	...
	private void initialize(int[] data, int index) {
		ID = data[index++];		
		raceID = data[index++];
