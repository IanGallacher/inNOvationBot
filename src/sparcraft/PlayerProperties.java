...
public class PlayerProperties {
	...
	public void SetUpgradeLevel(javabot.types.UpgradeType upgrade, int level)
	{
		assert(upgrade.getID() != javabot.types.UpgradeType.UpgradeTypes.None.getID());
		assert(upgrade.getID() != javabot.types.UpgradeType.UpgradeTypes.Unknown.getID());
	...
	public boolean HasUpgrade(javabot.types.UpgradeType upgrade) 
	{ 
