...
public class Unit implements Comparable<Unit> {
	...
	public int getArmor() {
		  return UnitProperties.Get(_unitType.getID()).GetArmor(PlayerProperties.Get(player())); 
	}
	...
	public void setUnitCooldown(bwapi.Unit unit){
	        int attackCooldown=0;
	        int moveCooldown=0;

	        UnitCommandType lastCommand = unit.getLastCommand().getUnitCommandType();
	        int lastCommandFrame = unit.getLastCommandFrame();
	        int currentFrame = Globals.game.getFrameCount();
